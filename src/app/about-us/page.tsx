        ...
        <Card className="max-w-3xl mx-auto shadow-lg">
          ...
          <CardContent className="space-y-6 prose prose-sm sm:prose-base dark:prose-invert max-w-none">
            ...
            <section aria-labelledby="welcome-heading">
              <h2 id="welcome-heading" className="sr-only">Welcome to Promptastic!</h2>
              <p>Welcome to Promptastic!, your modern solution for seamless script delivery and presentation.</p>
            </section>
            
            <section aria-labelledby="mission-heading">
              <h2 id="mission-heading" className="text-xl font-semibold mt-6">Our Mission</h2>
              <p>
            ...
            <section aria-labelledby="what-is-promptastic-heading">
              <h2 id="what-is-promptastic-heading" className="text-xl font-semibold mt-6">What is Promptastic!?</h2>
              <p>
            ...
            <section aria-labelledby="key-features-heading">
              <h2 id="key-features-heading" className="text-xl font-semibold mt-6">Key Features</h2>
            ...
            <section aria-labelledby="developer-heading">
              <h2 id="developer-heading" className="text-xl font-semibold mt-6">The Developer</h2>
              <p>
